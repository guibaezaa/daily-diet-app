...
2. Faça um fork e um branch com uma mudança por tópico.
3. Envie um pull request com descrição clara.

## Licença

Adicione aqui a licença do projeto, se houver (ex.: MIT).

---

Se quiser, posso acrescentar exemplos de testes, um script para inicializar o banco ou documentação automática (Swagger/OpenAPI). Diga o que prefere a seguir.
